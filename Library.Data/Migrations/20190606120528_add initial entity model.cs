        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryAssetId = table.Column<string>(nullable: true),
                    LibraryCardId = table.Column<string>(nullable: true),
                    ChekedOut = table.Column<DateTime>(nullable: false),
                    ChekedIn = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryAssetId = table.Column<string>(nullable: true),
                    LibraryCardId = table.Column<string>(nullable: true),
                    HoldPlacer = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
